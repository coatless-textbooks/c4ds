...
Welcome to the Computing for Data Science companion textbook. Within this section, we'll
...
statistical code in a data science context within the _R_ programming language. However, the goal is _not_
...
if you are in need of a local copy, a [**pdf version** is also available](https://c4ds.thecoatlessprofessor.com/c4ds.pdf).
...
](https://github.com/coatless-textbooks/c4ds). Within the online version, there is
...
send an email to `balamuta AT stanford DOT edu` that includes: the error and a
possible revision. Please put in the subject header: `[c4ds]`.
